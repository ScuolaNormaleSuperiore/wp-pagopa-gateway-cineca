...
Se questi campi non sono specificati il plugin funziona lo stesso, ma un cliente verrà considerato come una persona fisica con **Codice Fiscale = Nome + Cognome**.
